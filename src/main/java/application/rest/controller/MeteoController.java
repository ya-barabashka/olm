...
import application.rest.service.MeteoForecastLocationService;
...
//    private MeteoForecastLocationService meteoForecastLocationService;
...
//    }
    ...
    WeatherForecast newWeather(HttpServletRequest request, @RequestBody WeatherForecast weatherForecast) throws IOException, InterruptedException, InvalidRangeException {
...
//        locationService = new LocationService(weatherForecast.getCurrentObservationTime(), weatherForecast.getCurrentValidationTime());
        ...
        System.out.println("PressureToMSL => " + PressureToMSL.getPressureToMSLMap());
